...
description: Architecture guidance for the in-app course editor -- tool modes (sculpt/paint/place/select), undo/redo via command pattern, heightmap sculpting workflow, surface painting approach, object placement, export, and the playtest loop. Use whenever building or modifying editor tooling, especially Phase 5 of the roadmap.
---
