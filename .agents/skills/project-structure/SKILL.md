...
description: Baseline folder layout and coding conventions for this project (module boundaries, no heavy state-management frameworks, pure functions for testable physics/math, centralized tuning constants). Use at the start of any phase to confirm where new files belong and how they should be structured, and when onboarding a fresh session with no prior context.
---
