---
name: course-data-schema
description: Defines the JSON schema for course/hole data (heightmap reference, tee/pin, surfaces, hazards, objects) shared by the game loader and the course editor. Use whenever reading, writing, validating, or exporting course/hole data, or when the game loader or editor export code needs to agree on a data format. Relevant to Phase 3 (course loading) and Phase 5 (editor export).
---
