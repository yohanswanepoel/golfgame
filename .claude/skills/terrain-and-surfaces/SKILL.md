---
name: terrain-and-surfaces
description: Covers building a heightmap terrain mesh with matching physics collider, surface-type lookup (fairway/rough/sand/green/water), per-surface friction and restitution, slope-based roll on greens, and hazard trigger detection. Use whenever implementing terrain rendering, ball-terrain interaction, or surface-dependent physics, especially Phase 2 of the roadmap.
---

# Terrain & Surface Physics
